document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (event) {
        ...
        const defaultString = "company and startup"; // Your default string

        if (searchTerm) {
            // Concatenate the default string and user input
            const fullSearchTerm = `${searchTerm} ${defaultString}`;
            searchWikipedia(fullSearchTerm);
        }
    });
